...
document.addEventListener('DOMContentLoaded', () => {
  ...
  blogPostLinks.forEach(link => {
    link.addEventListener('click', (e) => {
      e.preventDefault();
      showNotification('🚧 Blog section is under development. Coming soon!');
      
      // Optional: Add a delay before redirecting to the actual blog post
      // Remove this if you want to prevent navigation completely
      // setTimeout(() => {
